$(document).ready(function() {
    ...
    $(".video-item").click(function () {
  	    var url = 'http://' + window.location.hostname + ':9999/videos/'+ this.id
...
function registerUser(callback) {
	...
	var dat = {
		'url': 'http://'+ window.location.hostname + ':8888/user',
		'method': 'POST',
...
function signinUser(callback) {
	...
	var dat = {
		'url': 'http://'+ window.location.hostname + ':8888/user/' + username,
		'method': 'POST',
		'req_body': JSON.stringify(reqBody)
	};
...
function getUserId(callback) {
	var dat = {
		'url': 'http://' + window.location.hostname + ':8888/user/' + uname,
		'method': 'GET'
	};
...
function createVideo(vname, callback) {
	...
	var dat = {
		'url': 'http://' + window.location.hostname + ':8888/user/' + uname + '/videos',
		'method': 'POST',
		'req_body': JSON.stringify(reqBody)
	};
...
function deleteVideo(vid, callback) {
  var dat = {
    'url': 'http://' + window.location.hostname + ':8888/user/' + uname + '/videos/' + vid,
    'method': 'DELETE',
    'req_body': ''
  };
...
function postComment(vid, content, callback) {
 var reqBody = {
  ...
  var dat = {
    'url': 'http://' + window.location.hostname + ':8888/videos/' + vid + '/comments',
    'method': 'POST',
    'req_body': JSON.stringify(reqBody)
  };
